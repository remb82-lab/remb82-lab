...
![PWA](https://img.shields.io/badge/PWA-111111?style=flat-square&logo=pwa)
...
Открыт к выборочным проектам, где нужно быстро пройти путь **от идеи до работающего продукта**.

- AI-powered MVP и внутренние инструменты
- Web / PWA / mobile-first приложения
- интерактивные игровые и streaming demo
- AI-автоматизация и agent workflows
- прототипы с дальнейшим выходом в production
...
[![GitHub](https://img.shields.io/badge/GitHub-remb82--lab-181717?style=for-the-badge&logo=github)](https://github.com/remb82-lab)
